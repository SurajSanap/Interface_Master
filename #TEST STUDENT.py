...
def export_data():
    ...
    table = pandas.DataFrame(newlist, columns=['Id', 'Name', 'Mobile', 'Email', 'Address', 'Gender', 'DOB', 'Added Date',
                                           'Added Time'])
...
clock()
s='NBN Student Management System' #s[count]=t when count is 1
...
logo_image=PhotoImage(file='Boys.png')
...
style.configure('Treeview', rowheight=40,font=('arial', 12, 'bold'), fieldbackground='powderblue', background='black',)
