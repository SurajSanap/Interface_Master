...
def login():
    ...
    elif usernameEntry.get()=='Suraj' and passwordEntry.get()=='1234':
...
#----------
backgroundImage=ImageTk.PhotoImage(file='student1.jpg')
...
logoImage=PhotoImage(file='Sinhgad logo2.png')
