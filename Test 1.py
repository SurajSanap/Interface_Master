...
logoImage = PhotoImage(file='Interface Logo.png')
...
passwordEntry = Entry(loginFrame, font=('times new roman', 20, 'bold'), bd=5, fg='blue', show='*')
passwordEntry.grid(row=2, column=1, pady=10, padx=20)

loginButton = Button(loginFrame, text='Interface', font=('times new roman', 14, 'bold'), width=50,
...
Options = ['Student', 'Hospital', 'Vehicle']
